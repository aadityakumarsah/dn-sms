...
const LOG = [
  ...
  { date: "Falgun 3, 2081", status: "holiday", remarks: "School Holiday" },
  ...
  { date: "Falgun 9, 2081", status: "absent", remarks: "Sick – Parent notified" },
  ...
  { date: "Falgun 15, 2081", status: "holiday", remarks: "Shivaratri" },
  ...
  return (
    <div className="p-6 space-y-5">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-0.5">Aarav Sharma — Class 10 A · {MONTH_NAME}</p>
      </div>
